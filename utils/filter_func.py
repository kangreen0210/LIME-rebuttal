...
def difficult_filter_func(task_path,threshold=1.0):
    ...
    with open(task_path) as json_file:
        ...
        for k,model_scores in data.items():
            ...
            elif 3<=count<6:middle_list.append(k)
            elif 6<=count<9:easy_list.append(k)
...
if __name__=='__main__':
    ...
    filter_list=filter_func('/ML-A100/team/mm/zk/lmms-eval/static_result/result_infovqa_val.json',threshold=1.0)
    # filter_list=filter_func('/ML-A100/team/mm/zk/lmms-eval/static_result/result_nocaps_val.json',threshold=0.2)
    # print(filter_list)
    print(f'the length of list is {len(filter_list)}')
    easy_list,middle_list,hard_list=difficult_filter_func('/ML-A100/team/mm/zk/lmms-eval/static_result/result_infovqa_val.json',threshold=1.0)
