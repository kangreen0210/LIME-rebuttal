...
if __name__=='__main__':
    # filter_list=filter_func('./static_result/result_ok.json',threshold=0.6)
    # print(filter_list)
    # print(f'the length of list is {len(filter_list)}')
    filter_list=filter_func('./static_result/result_ai2d_text_only_VD.json',threshold=1.0)
    # filter_list=filter_func('./static_result/result_nocaps_val.json',threshold=0.2)
    # print(filter_list)
    print(f'the length of list is {len(filter_list)}')
